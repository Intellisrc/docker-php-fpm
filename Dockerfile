...
# Change ALPINE value as well (also ioncube library)
FROM alpine:3.12
EXPOSE 80
VOLUME ["/var/www"]
...
RUN apk add --update --no-cache \
	...
	php$PHP_VER-curl php$PHP_VER-gd php$PHP_VER-json php$PHP_VER-session php$PHP_VER-pdo_mysql php$PHP_VER-gettext \
